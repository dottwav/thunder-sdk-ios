...
#ifndef ADTONOSLINKGENERATOR_SWIFT_H
#define ADTONOSLINKGENERATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdTonosLinkGenerator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Allow access to AdTonos through Objective-C
SWIFT_CLASS("_TtC20AdTonosLinkGenerator15ObjC_AdTonosSDK")
@interface ObjC_AdTonosSDK : NSObject
/// Shared object for VAST advertisements handling.
/// since:
/// 1.0.0
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ObjC_AdTonosSDK * _Nonnull shared;)
+ (ObjC_AdTonosSDK * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
///
/// \param buidlerId The builder id that is returned in the <code>ObjC_AdTonosSDK/createBuilder()</code> method.
///
...
///
/// throws:
/// Error of type <code>AdTonosLinkGenerator/AdTonosBuilderError</code>
///
/// returns:
/// URL as a string.
